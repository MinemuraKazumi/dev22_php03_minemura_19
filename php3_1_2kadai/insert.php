...
// 1. SQL文を用意 insertは記録するという意味 SQLから入力するときは INSERT INTO gs_book_table(id, name, url, comment, indate) VALUES (NULL, 'name', 'url', 'comment', sysdate());
...
if($status==false){
  ...
  //５．index.phpへリダイレクト 処理した後に元の画面に戻る
